...
then
    ...
    echo -e "\t\tfamily | length | copies | n_domains | repbase_hit | repbase_pident | repbase_qcov | domains | sat_hit | sat_qcov\n"
    exit
fi
...
echo -e "family\tlength\tcopies\tn_domains\trepbase_hit\trepbase_pident\trepbase_qcov\tdomains\tsat_hit\tsat_qcov" > final_priority.table.tab
