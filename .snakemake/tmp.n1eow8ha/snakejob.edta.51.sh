...
# properties = {"type": "single", "rule": "edta", "local": false, "input": ["/user/brussel/109/vsc10945/home/scratch/AmphibianTELibrary/Genomes/Crinia_signifera/Crinia_signifera_headers.fna"], "output": ["/user/brussel/109/vsc10945/home/scratch/AmphibianTELibrary/Genomes/Crinia_signifera/Crinia_signifera.denovo"], "wildcards": {"species": "Crinia_signifera"}, "params": {"species_dir": "/user/brussel/109/vsc10945/home/scratch/AmphibianTELibrary/Genomes/Crinia_signifera", "curatedlib": "/user/brussel/109/vsc10945/home/scratch/TE/Libraries/repbase/31/RepBase31.03.fasta/vrtrep.ref"}, "log": ["/user/brussel/109/vsc10945/home/scratch/AmphibianTELibrary/LOGS/edta/edta_Crinia_signifera.log"], "threads": 1, "resources": {"mem_mb": 6247, "mem_mib": 5958, "disk_mb": 100000, "disk_mib": 95368, "tmpdir": "<TBD>", "nodes": 1, "tasks": 1, "cpus_per_task": 16, "mem_mb_per_cpu": 25000, "runtime": 7200, "partition": "zen4,zen5_mpi"}, "jobid": 51}
cd /rhea/scratch/brussel/vo/000/bvo00034/vsc10945/Snakemake/AmphibianTElib && /apps/brussel/RL9/zen2-ib/software/Python/3.12.3-GCCcore-13.3.0/bin/python -m snakemake --snakefile '/rhea/scratch/brussel/vo/000/bvo00034/vsc10945/Snakemake/AmphibianTElib/Snakefile' --target-jobs 'edta:species=Crinia_signifera' --allowed-rules edta --cores 24 --attempt 1 --force-use-threads  --resources 'mem_mb=6247' 'mem_mib=5958' 'disk_mb=100000' 'disk_mib=95368' 'nodes=1' 'tasks=1' 'cpus_per_task=16' 'mem_mb_per_cpu=25000' --wait-for-files '/rhea/scratch/brussel/vo/000/bvo00034/vsc10945/Snakemake/AmphibianTElib/.snakemake/tmp.n1eow8ha' '/user/brussel/109/vsc10945/home/scratch/AmphibianTELibrary/Genomes/Crinia_signifera/Crinia_signifera_headers.fna' --force --target-files-omit-workdir-adjustment --keep-storage-local-copies --max-inventory-time 0 --nocolor --notemp --no-hooks --nolock --ignore-incomplete --rerun-triggers input code software-env params mtime --deployment-method env-modules --conda-frontend 'conda' --shared-fs-usage software-deployment source-cache sources persistence input-output storage-local-copies --wrapper-prefix 'https://github.com/snakemake/snakemake-wrappers/raw/' --printshellcmds  --latency-wait 60 --scheduler 'ilp' --local-storage-prefix .snakemake/storage --scheduler-solver-path '/apps/brussel/RL9/zen2-ib/software/Python/3.12.3-GCCcore-13.3.0/bin' --configfiles /rhea/scratch/brussel/vo/000/bvo00034/vsc10945/Snakemake/AmphibianTElib/master/config/config.yaml --default-resources base64//bWVtX21iPW1pbihtYXgoMippbnB1dC5zaXplX21iLCAxMDAwKSwgODAwMCk= base64//ZGlza19tYj0xMDAwMDA= base64//dG1wZGlyPXN5c3RlbV90bXBkaXI= base64//bm9kZXM9MQ== base64//dGFza3M9MQ== base64//Y3B1c19wZXJfdGFzaz02 base64//bWVtX21iX3Blcl9jcHU9NDAwMA== base64//cnVudGltZT00MzIw base64//cGFydGl0aW9uPXplbjQsemVuNV9tcGk= --mode 'remote' && touch '/rhea/scratch/brussel/vo/000/bvo00034/vsc10945/Snakemake/AmphibianTElib/.snakemake/tmp.n1eow8ha/51.jobfinished' || (touch '/rhea/scratch/brussel/vo/000/bvo00034/vsc10945/Snakemake/AmphibianTElib/.snakemake/tmp.n1eow8ha/51.jobfailed'; exit 1)
